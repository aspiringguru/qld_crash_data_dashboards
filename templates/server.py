...
print("df_traffic_census.columns:", df_traffic_census.columns)

@app.route('/get_traffic_survey_2020')
def get_traffic_survey_2020():
    print("@app.route:/get_traffic_survey_2020:df_traffic_census.shape:", df_traffic_census.shape)
    return json.loads(df_traffic_census.to_json(orient="table"))
